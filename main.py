...
class AppSSO(MDApp):
    abas_excel = ['ADENILSON', 'AILSON', 'ALAN PATRIKI', 'ALESSANDRO', 'ALEXSANDRO',
                  'ALZEMIR', 'AMANDA', 'ANA DEUSA', 'ANTONIO FORTES', 'ANTONIO MARCOS',
                  'BENEDITA', 'BRENDA GUEDES', 'BRUNA LUANA', 'CESAR MORAIS',
                  'CLEILSON PEREIRA', 'DAVID CUNHA2', 'DENNER BRAZ', 'EDIEL SILVA',
                  'EDIVAN', 'EDSON CASTRO', 'EDUARDO MICHELL', 'ELIAS GARRIDO',
                  'ELIRIOMAR GAMA', 'ELTON SOUSA', 'EMERSON PAIXÃO', 'ENILSON MARIO',
                  'FABIO LIMA', 'FABRICIO OLIVEIRA', 'FELICIANO PIRES', 'GENISON SOUSA',
                  'GERSON CARLOS', 'HELEN FERREIRA', 'HELOISA MARTINS', 'IDEMILSON FERREIRA',
                  'ISRAEL CARLOS', 'ITALO CASTRO', 'JANDERSON LUÍS', 'JEAN REIS',
                  'JEFFERSON BRALLY', 'JERFERSON SOUSA', 'JHONATAN RODRIGUES', 'JOAO COSTA',
                  'JOAO PAULO', 'JOERFERSON RIBEIRO', 'JONAS CRUZ', 'JOSE CARLOS', 'JOSE CLEISON',
                  'JOSE ERLANDIO', 'JOSE MARIA', 'JOSE RIBAMAR', 'JOSEILSON', 'JOSEVALDO',
                  'JOSUE REIS', 'KEILA REIS', 'KELIANE ALMEIDA', 'LEONARDO MARVÃO', 'LUCAS FELIPE',
                  'LUIS FERNANDO', 'MARCELO JORGE', 'MARCIA ELIZABETH', 'MARCIEL ALVES',
                  'MARIA DE JESUS', 'MARIO PEREIRA', 'MAURICIO MENDONÇA', 'MAYARA COSTA',
                  'MISAC DE JESUS', 'NANDO MONTELO', 'NELIO FERREIRA', 'NELMISON PIMENTEL',
                  'ODILON RODRIGUES', 'PAULO SERGIO', 'PEDRO PAULO', 'RAFAEL ALCANTARA',
                  'RAIMUNDO FRANCISCO', 'RICARDINO', 'RODRIGO DA LUZ', 'RODRIGO LOUZEIRO',
                  'RONAILTON FREITAS', 'SARA RAQUEL', 'SELEMIAS MAIA', 'SIDINEY ROBERTO',
                  'SILVANO MAFRA', 'TIAGO BORGES', 'VALDEIR DIAS2', 'VALERIA DE JESUS',
                  'VALTER', 'VITOR HUGO', 'WAGNER COUTINHO2', 'WALLESON SOUSA',
                  'WANDERSON LEANDRO OLIVEIRA', 'WARLLEM FERREIRA', 'WEVERTON BARBOSA',
                  'YAN MATHEUS']
